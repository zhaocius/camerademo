...
package com.zhaocius.camera2mediarecorder;
...
//            final byte[] data68 = ImageUtil.getBytesFromImageAsType(image, 2);
//
...
//                    try {
//                        File newFile = new File(getActivity().getExternalFilesDir(null), "" + System.currentTimeMillis() + "image.png");
//
//                        BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(newFile));
//                        bitmap2.compress(Bitmap.CompressFormat.PNG, 10, bos);
//                        bos.flush();
//                        bos.close();
//                        bitmap2.recycle();
//                    } catch (Exception e) {
...
//            }).start();
    ...
    private File getVideoFile(Context context) {
        return new File(context.getExternalFilesDir(null), "" + System.currentTimeMillis() + "video.mp4");
    }
